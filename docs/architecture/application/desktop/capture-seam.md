...
| `check_permissions()`   | Report whether the OS grants what capture needs (Windows: always granted; a Linux backend would check its accessibility service). The obligation exists for a backend that needs a real readiness probe.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
