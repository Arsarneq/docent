 ...
 */
// Governance declared in scripts/area-map.json (see its declared-governance entry): the adoption chokepoint appends step-history records and enforces the append-only superset rule, so it is bound by the format's step-history rules; the per-platform schemas are authoritative for field semantics.
